...
- Para redes restritas, defina `ANDROID_SDK_MIRROR_URL` (URL base ou URL direta do ZIP dos cmdline-tools) antes de executar o script.


## Bootstrap do Gradle Wrapper
- Se `gradle/wrapper/gradle-wrapper.jar` estiver ausente, execute `./scripts/bootstrap_gradle_wrapper.sh`.
- Em rede restrita, defina `GRADLE_WRAPPER_JAR_URL` com URL interna para o binário.

## Requisito de Java
- Use JDK entre 17 e 21 para compatibilidade com AGP/Kotlin deste projeto.
